...
.btn-create-premium {
    height: 40px; padding: 0 1.5rem; background: white;
    color: var(--admin-primary); font-weight: 600; font-size: 0.875rem; border: none; border-radius: 8px; cursor: pointer;
    display: inline-flex; align-items: center; gap: 0.5rem; transition: 0.2s;
    box-shadow: 0 2px 4px rgba(255,255,255,0.2); white-space: nowrap;
}
.btn-create-premium:hover { transform: translateY(-1px); box-shadow: 0 4px 6px rgba(255,255,255,0.3); }
...
.filter-select {
    ...
    border-radius: 6px; padding: 0.25rem 0.5rem; background: white; outline: none; height: 32px;
}
.btn-filter-apply, .btn-filter-clear {
    width: 32px; height: 32px; border: 1px solid #93c5fd; border-radius: 6px;
    background: white; color: #1e40af; cursor: pointer; display: flex; align-items: center;
    justify-content: center; transition: 0.2s; text-decoration: none;
}
.btn-filter-apply:hover { background: #1e40af; color: white; }
.btn-filter-clear:hover { background: #fef2f2; color: #ef4444; border-color: #fecaca; }
...
.item-title { font-weight: 600; color: #334155; line-height: 1.3; }
...
.difficulty-stars { color: #fbbf24; font-size: 0.75rem; }

.status-badge {
    padding: 4px 10px; border-radius: 12px; font-size: 0.65rem; font-weight: 700; text-transform: uppercase;
}
...
.actions-compact.justify-center { justify-content: center; }
...
.pagination-bar {
    display: flex; justify-content: space-between; align-items: center;
    padding: 1rem 2rem; background: #f8fafc; border-top: 1px solid #e2e8f0;
}
...
.pagination-current { font-size: 0.85rem; font-weight: 600; color: #667eea; padding: 0 0.5rem; }
