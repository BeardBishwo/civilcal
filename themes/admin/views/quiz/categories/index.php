                    ...
                    <tbody id="categorySortable">
                        ...
                        <?php else: ?>
                            ...
                            foreach ($categories as $cat): 
                                $pActive = $cat['parent_active'] ?? 1;
                                $gpActive = $cat['grandparent_active'] ?? 1;
                                $isFrozen = ($pActive == 0 || $gpActive == 0);
                                $parentTitle = htmlspecialchars($cat['parent_title'] ?? 'Unassigned');
                            ...
                            <?php endif; ?>
                                <tr class="category-item group <?php echo $sectionId; ?>" data-id="<?php echo $cat['id']; ?>">
