                                        ...
                                        <div class="quiz-pill-row">
                                            <?php foreach ($items as $quiz): ?>
                                                <div class="quiz-tag">
                                                    ...
                                                    <?php
                                                    if ($quiz['stream_title'] && $quiz['edu_level_title']) {
                                                        echo htmlspecialchars($quiz['stream_title']) . ' + ' . htmlspecialchars($quiz['edu_level_title']);
                                                    } elseif ($quiz['stream_title']) {
                                                        echo htmlspecialchars($quiz['stream_title']);
                                                    } elseif ($quiz['edu_level_title']) {
                                                        echo htmlspecialchars($quiz['edu_level_title']);
                                                    } else {
                                                        echo 'Mixed / Global';
                                                    }
                                                    ?>
...
<script>
    async function generateQuizzes() {
        ...
        if (result.isConfirmed) {
            ...
            try {
                const response = await fetch('<?= app_base_url('admin/quiz/daily/generate') ?>', {
                    method: 'POST'
                });
