...
$menus = [
    ...
    [
        ...
        'location' => 'Mobile',
        'items_count' => 4,
        'modified_at' => '2024-01-17T16:45:00Z',
        'status' => 'active'
    ],
    [
        'id' => '4',
        ...
        'location' => 'Header',
        'items_count' => 3,
        'modified_at' => '2024-01-16T11:30:00Z',
        'status' => 'inactive'
    ]
];
...
.location-icon.header { background: #667eea; }
.location-icon.footer { background: #48bb78; }
.location-icon.mobile { background: #ed8936; }
