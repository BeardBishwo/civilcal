...
<div class="row">
    <div class="col-md-3">
        <div class="list-group mb-4">
            <a href="<?= app_base_url('/admin/settings') ?>" class="list-group-item list-group-item-action active">
                <i class="fas fa-cogs mr-2"></i> General
            </a>
            <a href="<?= app_base_url('/admin/settings/users') ?>" class="list-group-item list-group-item-action">
                <i class="fas fa-users-cog mr-2"></i> Users
            </a>
            <a href="<?= app_base_url('/admin/settings/security') ?>" class="list-group-item list-group-item-action">
                <i class="fas fa-shield-alt mr-2"></i> Security
            </a>
            <a href="<?= app_base_url('/admin/settings/email') ?>" class="list-group-item list-group-item-action">
                <i class="fas fa-envelope mr-2"></i> Email
            </a>
            <a href="<?= app_base_url('/admin/settings/api') ?>" class="list-group-item list-group-item-action">
                <i class="fas fa-code mr-2"></i> API
            </a>
            <a href="<?= app_base_url('/admin/settings/performance') ?>" class="list-group-item list-group-item-action">
                <i class="fas fa-tachometer-alt mr-2"></i> Performance
            </a>
            <a href="<?= app_base_url('/admin/settings/advanced') ?>" class="list-group-item list-group-item-action">
    ...
    <div class="col-md-9">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= app_base_url('/admin/settings/save') ?>" method="post" enctype="multipart/form-data">
                    <?php
