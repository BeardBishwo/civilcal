<?php
/**
 * CREATE SUBSCRIPTION PLAN - PREMIUM DESIGN
 * Matching the Pages Management Interface Style
 */
?>
    ...
    <div class="admin-content-wrapper">
        ...
        <div class="compact-header">
            <div class="header-left">
                ...
                <div class="header-subtitle">Design and configure a new subscription plan for your platform</div>
            </div>
        ...
        <div class="form-content-area">
            <form id="createPlanForm" method="POST" action="<?php echo app_base_url('/admin/subscriptions/store'); ?>">
                            ...
                            <div class="form-card-body">
                                <div class="plan-preview">
                                    <div class="preview-header">
                                        <h3 class="preview-plan-name" id="previewName">Plan Name</h3>
                                    ...
                                    <p class="preview-description" id="previewDescription">Plan description will appear here...</p>
                                    <div class="preview-pricing">
                                        <div class="preview-price-item">
                                            <span class="preview-price-label">Monthly</span>
                                            <span class="preview-price-value" id="previewMonthly">$0.00</span>
                                        </div>
                                        <div class="preview-price-item">
                                            <span class="preview-price-label">Yearly</span>
                                            <span class="preview-price-value" id="previewYearly">$0.00</span>
                                        </div>
                                    </div>
...
<style>
    /* ========================================
       ADMIN WRAPPER (Matching Pages Style)
       ======================================== */
    ...
    /* ========================================
       COMPACT HEADER (Matching Pages Style)
       ======================================== */
    ...
    .status-option input[type="radio"]:checked + .status-option-label.status-active {
        border-color: #48bb78;
        background: rgba(72, 187, 120, 0.1);
        color: #48bb78;
    }

    .status-option input[type="radio"]:checked + .status-option-label.status-inactive {
        border-color: #ed8936;
    ...
    .feature-input-wrapper:focus-within {
        border-color: #667eea;
        box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.1);
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.removeFeature = function(btn) {
        ...
        // Ensure at least one feature input
