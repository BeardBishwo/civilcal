...
<body>
    <div class="container">
        ...
        <div class="calc-card">
            <div class="calc-header">
                ...
                <p class="mb-0 mt-2">Calculate monthly payments & total interest</p>
            </div>
            <div class="calc-body">
                <div class="mb-3">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" id="months" class="form-control calc-input" value="12">
                    </div>
                </div>
    ...
    <script>
        ...
        function calculate() {
            ...
            fetch(appBase + '/calculator/api/loan', {
                method: 'POST',
