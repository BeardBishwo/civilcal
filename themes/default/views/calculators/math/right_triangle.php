...
<div class="bg-background min-h-screen relative overflow-hidden" x-data="triangleCalculator()">
    ...
    <div class="calc-container">
        ...
        <div class="calc-header animate-slide-down">
            ...
            <h1 class="calc-title">Right <span class="text-gradient">Triangle</span></h1>
            <p class="calc-subtitle">Enter any two values (sides or angles) to instantly solve the entire triangle.</p>
        </div>
