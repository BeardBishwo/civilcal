...
<main class="flex-1 flex overflow-hidden">
    ...
    <aside class="w-72 bg-surface/50 border-r border-white/10 flex flex-col hidden md:flex shrink-0">
        ...
        <div class="p-4 border-t border-white/10 text-xs text-gray-400 space-y-2">
            <div class="flex items-center gap-2"><div class="w-2 h-2 rounded-full bg-green-500"></div> Answered</div>
            <div class="flex items-center gap-2"><div class="w-2 h-2 rounded-full bg-primary"></div> Current</div>
            <div class="flex items-center gap-2"><div class="w-2 h-2 rounded-full bg-yellow-500"></div> Marked</div>
            <div class="flex items-center gap-2"><div class="w-2 h-2 rounded-full bg-white/20 border border-white/10"></div> Not Answered</div>
        </div>
    </aside>
