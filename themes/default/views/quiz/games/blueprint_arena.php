<div id="blueprint-arena" class="min-vh-100" style="background: radial-gradient(circle at top right, #000000, #111827); color: #fff; font-family: 'Outfit', sans-serif;">
    <!-- HUD -->
...
<style>
body { background-color: #000000 !important; overflow-y: auto !important; }
