...
class EnhanceSettingsTable {
    ...
    private function insertDefaultSettings($pdo) {
        $defaultSettings = [
            ...
            ['timezone', 'Asia/Kathmandu', 'select', 'general', 'regional', 'System timezone', 1, '{"options": ["Asia/Kathmandu", "UTC", "America/New_York", "Europe/London", "Asia/Tokyo"]}', 0, '6'],
            ['date_format', 'Y-m-d', 'select', 'general', 'regional', 'Date format', 1, '{"options": ["Y-m-d", "d/m/Y", "m/d/Y", "d-m-Y"]}', 0, '7'],
            ['time_format', 'H:i:s', 'select', 'general', 'regional', 'Time format', 1, '{"options": ["H:i:s", "h:i A", "H:i"]}', 0, '8'],
            ['items_per_page', '20', 'integer', 'general', 'display', 'Items per page in lists', 1, '{"min": 10, "max": 100}', 0, '9'],
            ['default_language', 'en', 'select', 'general', 'regional', 'Default language', 1, '{"options": ["en", "ne", "hi"]}', 0, '10'],
            
            // Appearance Settings
            ['theme', 'default', 'select', 'appearance', 'theme', 'Active theme', 1, 0, '1'],
            ['logo', '/assets/images/logo.png', 'image', 'appearance', 'branding', 'Site logo', 1, 0, '2'],
            ['favicon', '/assets/images/favicon.ico', 'image', 'appearance', 'branding', 'Site favicon', 1, 0, '3'],
