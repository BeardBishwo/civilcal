<?php
/**
 * Create Export Templates Table Migration
 * Handles user export templates storage
 */
...
try {
    ...
    $pdo->exec($sql);
    echo "✅ Created export_templates table\n";
    ...
    echo "✅ Created default export templates\n";
    
} catch (Exception $e) {
    echo "❌ Error creating export_templates table: " . $e->getMessage() . "\n";
}
?>
