...
// Get current application settings (mock data for demonstration)
$app_settings = [
    'maintenance_mode' => [
    ...
    'debug_mode' => [
        ...
        'type' => 'checkbox',
        'required' => false,
        'description' => 'Enable debug mode for development (shows detailed error messages)'
    ],
    'cache_enabled' => [
    ...
    'backup_frequency' => [
        ...
        'required' => true,
        'description' => 'How often to create automatic system backups'
    ],
    'log_level' => [
        'label' => 'Logging Level',
        'value' => 'info',
        ...
        'required' => true,
        'description' => 'Level of detail for system logging'
    ],
    'cleanup_interval' => [
        'label' => 'Data Cleanup Interval',
        'value' => 'weekly',
        'type' => 'select',
        'options' => [
            'never' => 'Never',
        ...
        'required' => true,
        'description' => 'How often to clean up temporary files and logs'
    ],
    'enable_registration' => [
...
$page_title = 'Application Settings - Admin Panel';
?>
        ...
        <div class="admin-content">
            ...
            <form id="settingsForm" method="POST" action="#">
                ...
                <div class="settings-card">
                    ...
                    <?php foreach ($app_settings as $key => $setting): ?>
