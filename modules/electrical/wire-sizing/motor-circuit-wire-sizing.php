    ...
    <body>
        <div class="container">
            <div class="calculator-wrapper">
                ...
                <div class="motor-note">
                    <i class="fas fa-info-circle me-2"></i> NEC 430.6(A) requires motor circuit conductors to have an ampacity of at least 125% of the motor full-load current (FLC). Circuit breakers are typically sized at 250% of FLC for motors.
                </div>
        ...
        <script>
            function getMotorFLC(hp, voltage, phase) {
                ...
                if (phase === 1) {
                    return singlePhaseFLC[voltage] ? .[hpString] || 0;
                } else {
                    return threePhaseFLC[voltage] ? .[hpString] || 0;
                }
            }
