<?php
// modules/civil/structural/beam-load-capacity.php
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Beam Load Capacity Calculator - AEC Toolkit</title>
...
<body>
    <div class="container">
        <div class="calculator-wrapper">
            <h1>Beam Load Capacity Calculator</h1>
            <form id="beam-load-form">
    ...
    <script>
        document.getElementById('beam-load-form').addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            document.getElementById('result').innerHTML = `Max Moment: ${maxMoment.toFixed(2)} kN·m`;
