...
// Get current email settings (mock data for demonstration)
$email_settings = [
    'smtp_host' => [
        'label' => 'SMTP Host',
    ...
    'smtp_password' => [
        ...
        'type' => 'password',
        'required' => false,
        'description' => 'SMTP authentication password (leave empty to keep current)'
    ],
    'from_email' => [
    ...
    'notification_email' => [
        ...
        'value' => 'notifications@bishwocalculator.com',
        'type' => 'email',
        'required' => false,
    ...
    'email_timeout' => [
        ...
        'type' => 'number',
        'required' => true,
        'description' => 'Timeout for email sending operations',
        'min' => '5',
        'max' => '300'
    ]
];
...
$page_title = 'Email Settings - Admin Panel';
?>
        ...
        <div class="admin-content">
            ...
            <form id="settingsForm" method="POST" action="#">
                ...
                <div class="settings-card">
                    ...
                    <?php foreach ($email_settings as $key => $setting): ?>
                        <div class="form-group">
                            ...
                            <?php elseif (($setting['type'] ?? 'text') === 'password'): ?>
                                <input type="password" 
                                       name="settings[<?php echo $key; ?>]" 
