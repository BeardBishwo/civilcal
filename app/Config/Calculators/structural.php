...
return [
    ...
    'raft-foundation' => ['name' => 'Raft Foundation', 'description' => 'Design mat foundation', 'category' => 'structural', 'subcategory' => 'foundation-design', 'version' => '1.0', 'inputs' => [['name' => 'load', 'type' => 'number', 'label' => 'Total Load', 'unit' => 'kN', 'required' => true, 'min' => 0], ['name' => 'sbc', 'type' => 'number', 'label' => 'SBC', 'unit' => 'kN/m²', 'required' => true, 'min' => 0, 'default' => 150]], 'formulas' => ['area' => function($i) { return $i['load'] / $i['sbc']; }], 'outputs' => [['name' => 'area', 'label' => 'Mat Area', 'unit' => 'm²', 'precision' => 2]]],
    'foundation-pressure' => ['name' => 'Foundation Pressure', 'description' => 'Calculate pressure on soil', 'category' => 'structural', 'subcategory' => 'foundation-design', 'version' => '1.0', 'inputs' => [['name' => 'load', 'type' => 'number', 'label' => 'Load', 'unit' => 'kN', 'required' => true], ['name' => 'area', 'type' => 'number', 'label' => 'Area', 'unit' => 'm²', 'required' => true]], 'formulas' => ['pressure' => function($i) { return $i['load'] / $i['area']; }], 'outputs' => [['name' => 'pressure', 'label' => 'Base Pressure', 'unit' => 'kN/m²', 'precision' => 2]]],
    ...
    'slab-load-calculation' => ['name' => 'Slab Load Calculator', 'description' => 'Calculate loads on slab', 'category' => 'structural', 'subcategory' => 'slab-design', 'version' => '1.0', 'inputs' => [['name' => 'area', 'type' => 'number', 'label' => 'Area', 'unit' => 'm²', 'required' => true]], 'formulas' => ['total_load' => function($i) { return $i['area'] * 5; }], 'outputs' => [['name' => 'total_load', 'label' => 'Total Load', 'unit' => 'kN', 'precision' => 2]]],
    ...
    'stirrup-design' => ['name' => 'Stirrup Design', 'description' => 'Calculate stirrup spacing', 'category' => 'structural', 'subcategory' => 'reinforcement', 'version' => '1.0', 'inputs' => [['name' => 'shear', 'type' => 'number', 'label' => 'Shear Force', 'unit' => 'kN', 'required' => true, 'min' => 0], ['name' => 'depth', 'type' => 'number', 'label' => 'Effective Depth', 'unit' => 'mm', 'required' => true, 'min' => 0]], 'formulas' => ['spacing' => function($i) { return min(0.75 * $i['depth'], 300); }], 'outputs' => [['name' => 'spacing', 'label' => 'Max Spacing', 'unit' => 'mm', 'precision' => 0]]],
    'rebar-anchorage' => ['name' => 'Rebar Anchorage', 'description' => 'Calculate anchorage length', 'category' => 'structural', 'subcategory' => 'reinforcement', 'version' => '1.0', 'inputs' => [['name' => 'dia', 'type' => 'number', 'label' => 'Bar Diameter', 'unit' => 'mm', 'required' => true, 'min' => 0]], 'formulas' => ['length' => function($i) { return 16 * $i['dia']; }], 'outputs' => [['name' => 'length', 'label' => 'Anchorage Length', 'unit' => 'mm', 'precision' => 0]]],

    
    'steel-beam-design' => ['name' => 'Steel Beam Design', 'description' => 'Design steel beam', 'category' => 'structural', 'subcategory' => 'steel-structure', 'version' => '1.0', 'inputs' => [['name' => 'moment', 'type' => 'number', 'label' => 'Moment', 'unit' => 'kN·m', 'required' => true, 'min' => 0]], 'formulas' => ['section_modulus' => function($i) { return $i['moment'] * 1000000 / 165; }], 'outputs' => [['name' => 'section_modulus', 'label' => 'Required Z', 'unit' => 'mm³', 'precision' => 0]]],
    'steel-truss-analysis' => ['name' => 'Steel Truss', 'description' => 'Analyze steel truss', 'category' => 'structural', 'subcategory' => 'steel-structure', 'version' => '1.0', 'inputs' => [['name' => 'span', 'type' => 'number', 'label' => 'Span', 'unit' => 'm', 'required' => true, 'min' => 0]], 'formulas' => ['depth' => function($i) { return $i['span'] / 5; }], 'outputs' => [['name' => 'depth', 'label' => 'Truss Depth', 'unit' => 'm', 'precision' => 2]]],
    ...
    'purlin-design' => ['name' => 'Purlin Design', 'description' => 'Design steel purlins', 'category' => 'structural', 'subcategory' => 'steel-structure', 'version' => '1.0', 'inputs' => [['name' => 'span', 'type' => 'number', 'label' => 'Span', 'unit' => 'm', 'required' => true, 'min' => 0], ['name' => 'spacing', 'type' => 'number', 'label' => 'Spacing', 'unit' => 'm', 'required' => true, 'min' => 0]], 'formulas' => ['moment' => function($i) { return 5 * pow($i['span'], 2) / 8; }], 'outputs' => [['name' => 'moment', 'label' => 'Design Moment', 'unit' => 'kN·m', 'precision' => 2]]],
    'steel-base-plate' => ['name' => 'Base Plate Design', 'description' => 'Design steel column base plate', 'category' => 'structural', 'subcategory' => 'steel-structure', 'version' => '1.0', 'inputs' => [['name' => 'load', 'type' => 'number', 'label' => 'Column Load', 'unit' => 'kN', 'required' => true, 'min' => 0]], 'formulas' => ['area' => function($i) { return $i['load'] * 1000 / 10; }], 'outputs' => [['name' => 'area', 'label' => 'Required Plate Area', 'unit' => 'mm²', 'precision' => 0]]],
    ...
    'detailing-drawing' => ['name' => 'Detailing Drawing', 'description' => 'Reinforcement detailing settings', 'category' => 'structural', 'subcategory' => 'reinforcement', 'version' => '1.0', 'inputs' => [['name' => 'scale', 'type' => 'number', 'label' => 'Scale', 'default' => 50]], 'formulas' => ['status' => function($i) { return 'Ready'; }], 'outputs' => [['name' => 'status', 'label' => 'Status', 'type' => 'string']]],
    'reinforcement-optimizer' => ['name' => 'Reinforcement Optimizer', 'description' => 'Optimize steel usage', 'category' => 'structural', 'subcategory' => 'reinforcement', 'version' => '1.0', 'inputs' => [['name' => 'total_steel', 'type' => 'number', 'label' => 'Total Steel', 'unit' => 'kg']], 'formulas' => ['saving' => function($i) { return $i['total_steel'] * 0.05; }], 'outputs' => [['name' => 'saving', 'label' => 'Potential Saving', 'unit' => 'kg', 'precision' => 1]]],
    'beam-report' => ['name' => 'Beam Report', 'description' => 'Generate detailed beam report', 'category' => 'structural', 'subcategory' => 'reports', 'version' => '1.0', 'inputs' => [['name' => 'beam_id', 'type' => 'string', 'label' => 'Beam ID']], 'formulas' => ['status' => function($i) { return 'Generated'; }], 'outputs' => [['name' => 'status', 'label' => 'Status', 'type' => 'string']]],
    'column-report' => ['name' => 'Column Report', 'description' => 'Generate detailed column report', 'category' => 'structural', 'subcategory' => 'reports', 'version' => '1.0', 'inputs' => [['name' => 'column_id', 'type' => 'string', 'label' => 'Column ID']], 'formulas' => ['status' => function($i) { return 'Generated'; }], 'outputs' => [['name' => 'status', 'label' => 'Status', 'type' => 'string']]],
    'full-structure-summary' => ['name' => 'Full Structure Summary', 'description' => 'Summary of entire structure', 'category' => 'structural', 'subcategory' => 'reports', 'version' => '1.0', 'inputs' => [['name' => 'proj_id', 'type' => 'string', 'label' => 'Project ID']], 'formulas' => ['status' => function($i) { return 'Ready'; }], 'outputs' => [['name' => 'status', 'label' => 'Status', 'type' => 'string']]],
    'load-analysis-summary' => ['name' => 'Load Analysis Summary', 'description' => 'Summary of all loads', 'category' => 'structural', 'subcategory' => 'reports', 'version' => '1.0', 'inputs' => [['name' => 'area', 'type' => 'number', 'label' => 'Total Area']], 'formulas' => ['status' => function($i) { return 'Ready'; }], 'outputs' => [['name' => 'status', 'label' => 'Status', 'type' => 'string']]],
