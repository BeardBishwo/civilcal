...
return [
    ...
    'water-heater-sizing' => ['name' => 'Water Heater Sizing', 'description' => 'Calculate heater capacity', 'category' => 'plumbing', 'subcategory' => 'potable_water', 'version' => '1.0', 'inputs' => [['name' => 'ppl', 'type' => 'number', 'label' => 'People']], 'formulas' => ['cap' => function($i) { return $i['ppl'] * 40; }], 'outputs' => [['name' => 'cap', 'label' => 'Capacity', 'unit' => 'L']]],
    'recirculation-loop' => ['name' => 'Recirculation Loop Sizing', 'description' => 'Calculate loop parameters', 'category' => 'plumbing', 'subcategory' => 'potable_water', 'version' => '1.0', 'inputs' => [['name' => 'len', 'type' => 'number', 'label' => 'Loop Length', 'unit' => 'm']], 'formulas' => ['pump' => function($i) { return 0.5; }], 'outputs' => [['name' => 'pump', 'label' => 'Pump Flow', 'unit' => 'L/s']]],
    'safety-valve' => ['name' => 'Safety Valve Sizing', 'description' => 'Calculate relief valve requirements', 'category' => 'plumbing', 'subcategory' => 'potable_water', 'version' => '1.0', 'inputs' => [['name' => 'press', 'type' => 'number', 'label' => 'Set Pressure', 'unit' => 'bar']], 'formulas' => ['size' => function($i) { return 15; }], 'outputs' => [['name' => 'size', 'label' => 'Valve Size', 'unit' => 'mm']]],
    ...
    'storm-drainage' => ['name' => 'Storm Drainage Calculator', 'description' => 'Calculate roof drainage', 'category' => 'plumbing', 'subcategory' => 'drainage', 'version' => '1.0', 'inputs' => [['name' => 'area', 'type' => 'number', 'label' => 'Roof Area', 'unit' => 'm²']], 'formulas' => ['flow' => function($i) { return $i['area'] * 0.05; }], 'outputs' => [['name' => 'flow', 'label' => 'Flow', 'unit' => 'L/s']]],
    'vent-pipe-sizing' => ['name' => 'Vent Pipe Sizing', 'description' => 'Calculate plumbing vent sizes', 'category' => 'plumbing', 'subcategory' => 'drainage', 'version' => '1.0', 'inputs' => [['name' => 'dfu', 'type' => 'number', 'label' => 'Total DFU']], 'formulas' => ['size' => function($i) { return 50; }], 'outputs' => [['name' => 'size', 'label' => 'Vent Size', 'unit' => 'mm']]],
    'gutter-sizing' => ['name' => 'Gutter Sizing Calculator', 'description' => 'Size roof gutters', 'category' => 'plumbing', 'subcategory' => 'stormwater', 'version' => '1.0', 'inputs' => [['name' => 'area', 'type' => 'number', 'label' => 'Catchment Area', 'unit' => 'm²']], 'formulas' => ['width' => function($i) { return 150; }], 'outputs' => [['name' => 'width', 'label' => 'Gutter Width', 'unit' => 'mm']]],
    'downpipe-sizing' => ['name' => 'Downpipe Sizing Calculator', 'description' => 'Size roof downpipes', 'category' => 'plumbing', 'subcategory' => 'stormwater', 'version' => '1.0', 'inputs' => [['name' => 'area', 'type' => 'number', 'label' => 'Catchment Area', 'unit' => 'm²']], 'formulas' => ['dia' => function($i) { return 100; }], 'outputs' => [['name' => 'dia', 'label' => 'Downpipe Dia', 'unit' => 'mm']]],
    'stormwater-storage' => ['name' => 'Stormwater Storage Tank', 'description' => 'Calculate detention volume', 'category' => 'plumbing', 'subcategory' => 'stormwater', 'version' => '1.0', 'inputs' => [['name' => 'area', 'type' => 'number', 'label' => 'Site Area', 'unit' => 'm²']], 'formulas' => ['vol' => function($i) { return $i['area'] * 0.1; }], 'outputs' => [['name' => 'vol', 'label' => 'Storage Volume', 'unit' => 'm³']]],
    'pervious-area' => ['name' => 'Pervious Area Calculator', 'description' => 'Calculate site permeability', 'category' => 'plumbing', 'subcategory' => 'stormwater', 'version' => '1.0', 'inputs' => [['name' => 'area', 'type' => 'number', 'label' => 'Total Area', 'unit' => 'm²']], 'formulas' => ['ratio' => function($i) { return 30; }], 'outputs' => [['name' => 'ratio', 'label' => 'Permeability', 'unit' => '%']]],
