...
abstract class OptimizedController extends Controller
{
    ...
    {
        // If no token provided, try to get from input
        if ($token === null) {
     ...
     * 
     * @deprecated Use \App\Services\FileService instead for "Paranoid-Grade" security
     * @see \App\Services\FileService::uploadAdminFile()
     * @see \App\Services\FileService::uploadUserFile()
     */
    protected function uploadFile(string $inputName, array $allowedTypes = ['jpg', 'jpeg', 'png', 'gif'], int $maxSize = 5000000): array
    {
        // Log deprecation warning
        error_log('DEPRECATION WARNING: OptimizedController::uploadFile() is deprecated. Use FileService instead for secure uploads.');

        return [
            'success' => false,
            'error' => 'Deprecated method',
            'message' => 'This upload method is deprecated. Please use \App\Services\FileService for secure file uploads.'
        ];
    }
